				   ...
				   )
{
	...
	plyfile = (PlyFile *) ply_myalloc (sizeof (PlyFile));
	...
	plyfile->elems = (PlyElement **) ply_myalloc (sizeof (PlyElement *) * nelems);
	for (i = 0; i < nelems; i++) {
		elem = (PlyElement *) ply_myalloc (sizeof (PlyElement));
							  ...
							  )
{
	...
	name = (char *) ply_myalloc (int(sizeof (char) * (strlen (filename)) + 5));
						  ...
						  )
{
	...
	elem->nprops = nprops;
	elem->props = (PlyProperty **) ply_myalloc (sizeof (PlyProperty *) * nprops);
	elem->store_prop = (char *) ply_myalloc (sizeof (char) * nprops);
	
	for (i = 0; i < nprops; i++) {
		prop = (PlyProperty *) ply_myalloc (sizeof (PlyProperty));
		elem->props[i] = prop;
						   ...
						   )
{
	...
	if (elem->nprops == 0) {
		elem->props = (PlyProperty **) ply_myalloc (sizeof (PlyProperty *));
		elem->store_prop = (char *) ply_myalloc (sizeof (char));
		elem->nprops = 1;
	}
	else {
		elem->nprops++;
	...
	elem_prop = (PlyProperty *) ply_myalloc (sizeof (PlyProperty));
								   ...
								   )
{
	...
	if (elem->nprops == 0) {
		elem->props = (PlyProperty **)
			ply_myalloc (sizeof (PlyProperty *) * other->nprops);
		elem->store_prop = (char *) ply_myalloc (sizeof (char) * other->nprops);
		elem->nprops = 0;
	}
	else {
		int newsize;
 ...
 ******************************************************************************/
 ...
 void ply_put_comment(PlyFile *plyfile, char *comment)
 {
	 ...
	 if (plyfile->num_comments == 0)
		 plyfile->comments = (char **) ply_myalloc (sizeof (char *));
	 else
 ...
 ******************************************************************************/
 ...
 void ply_put_obj_info(PlyFile *plyfile, char *obj_info)
 {
	 ...
	 if (plyfile->num_obj_info == 0)
		 plyfile->obj_info = (char **) ply_myalloc (sizeof (char *));
	 else
 ...
 ******************************************************************************/
 ...
 PlyFile *ply_read(FILE *fp, int *nelems, char ***elem_names)
 {
	 ...
	 for (i = 0; i < plyfile->nelems; i++) {
		 elem = plyfile->elems[i];
		 elem->store_prop = (char *) ply_myalloc (sizeof (char) * elem->nprops);
		 for (j = 0; j < elem->nprops; j++)
	 ...
	 elist = (char **) ply_myalloc (sizeof (char *) * plyfile->nelems);
	 for (i = 0; i < plyfile->nelems; i++)
  ...
  ******************************************************************************/
	  ...
	  )
  {
	  ...
	  *nprops = elem->nprops;
	  ...
	  prop_list = (PlyProperty **) ply_myalloc (sizeof (PlyProperty *) * elem->nprops);
...
//		  fprintf( stderr, "Warning:  Can't find property '%s' in element '%s'\n" , prop->name, elem_name );
  ...
  ******************************************************************************/
	  ...
	  )
  {
	  ...
	  other = (PlyOtherProp *) ply_myalloc (sizeof (PlyOtherProp));
	  other->name = _strdup (elem_name);
	  other->size = elem->other_size;
	  other->props = (PlyProperty **) ply_myalloc (sizeof(PlyProperty) * elem->nprops);
  ...
  ******************************************************************************/
	  ...
	  )
  {
	  ...
	  if (plyfile->other_elems == NULL) {
		  plyfile->other_elems = (PlyOtherElems *) ply_myalloc (sizeof (PlyOtherElems));
		  other_elems = plyfile->other_elems;
		  other_elems->other_list = (OtherElem *) ply_myalloc (sizeof (OtherElem));
  ...
  ******************************************************************************/
  ...
  void ascii_get_element(PlyFile *plyfile, char *elem_ptr)
  {
	  ...
	  if (elem->other_offset != NO_OTHER_PROPS) {
		  ...
		  other_data = (char *) ply_myalloc (elem->other_size);
	  ...
	  for (j = 0; j < elem->nprops; j++) {
		  ...
		  if (prop->is_list) {       /* a list */
			  ...
			  if (list_count == 0) {
				  ...
				  if (store_it) {
					  item_ptr = (char *) ply_myalloc (sizeof (char) * item_size * list_count);
					  item = item_ptr;
...
#define BIG_STRING 4096
	  ...
	  words = (char **) ply_myalloc (sizeof (char *) * max_words);
  ...
  ******************************************************************************/
  ...
  void add_element (PlyFile *plyfile, char **words)
  {
	  ...
	  if (plyfile->nelems == 0)
		  plyfile->elems = (PlyElement **) ply_myalloc (sizeof (PlyElement *));
	  else
